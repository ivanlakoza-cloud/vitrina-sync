...
<title>Проверка полей (2b (api/soglasovanie-cen))</title>
<style>
...
<body>
  <div class="bar"><div class="wrap"><h1 style="margin:0">Проверка полей сделки перед отправкой на согласование — <b>2b (api/soglasovanie-cen)</b></h1></div></div>
  <div class="wrap"><p>Это API-роут, который рендерит HTML прямо из <code>app/api/…/route.ts</code>. Если вы видите этот текст — используется вариант 2b (api/soglasovanie-cen).</p></div>
</body></html>`;
